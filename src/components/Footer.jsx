        ...
        <div className={footerStyles.footerContainer}>
          <div className={footerStyles.footerGrid}>
            <div className={footerStyles.leftSection}>
              ...
              <ul className={footerStyles.socialList}>
                <li className={footerStyles.socialItem}>
                  <a href="#" title="" className={footerStyles.socialLink}>
                    <svg
            ...
            <div className={footerStyles.footerSection}>
              <p className={footerStyles.sectionTitle}>Company</p>

              <ul className={footerStyles.sectionLinks}>
                <li>
                  <a href="#" title="" className={footerStyles.sectionLink}>
                    About
                  </a>
                </li>
            ...
            <div className={footerStyles.footerSection}>
              <p className={footerStyles.sectionTitle}>Help</p>
            ...
            <div className={footerStyles.newsletterSection}>
              <p className={footerStyles.sectionTitle}>
              ...
              >
                <div className={footerStyles.emailInputWrapper}>
                  <input
                    type="email"
                    name="email"
                    id="email"
